...
const html=renderNotificationsPage({
  settings:{timezone:'Australia/Sydney',morning_summary_time:'07:15:00',quiet_hours_start:'22:00:00',quiet_hours_end:'07:00:00',birthday_offsets:[30,14,7,1],renewal_offsets:[60,30,14,7,1],deadline_offsets:[14,7,3,0],appointment_offsets:[7,1,0],trip_offsets:[14,7,1]},
...
assert.doesNotMatch(html,/07:05/);
