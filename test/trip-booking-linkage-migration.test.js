...
for(const pattern of [
  ...
  /create index life_items_linked_trip_owner_idx on public\.life_items \(linked_trip_id, user_id\)/i,
  ...
  /create index booking_source_links_booking_owner_idx on public\.booking_source_links \(booking_id, user_id\)/i,
  /create index booking_source_links_source_owner_idx on public\.booking_source_links \(source_record_id, user_id\)/i,
