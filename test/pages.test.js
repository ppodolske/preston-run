...
for (const expected of ['digest-insights','digest-insight','digest-insight-label','digest-insight-value','Sleep</span><strong class="digest-insight-value">Very short · 0h 0m','Sleep score</span><strong class="digest-insight-value">29 · Poor','Resting HR</span><strong class="digest-insight-value">+4 bpm vs baseline','Today&#39;s training</span><strong class="digest-insight-value">No workout planned','28-day weight trend</span><strong class="digest-insight-value">Up · +85.1 kg','Last 7 days</span><strong class="digest-insight-value">8 sessions','4 runs · 4 lifts · 33.4 km running']) assert.ok(home.includes(expected),`digest insight missing ${expected}`);
