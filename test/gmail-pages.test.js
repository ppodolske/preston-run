...
const connected=renderGmailSettingsPage({
  ...
  latestScan:{id:'scan1',scan_type:'initial',status:'succeeded',processed_count:12,relevant_count:3,ignored_count:9,review_items_created_count:1,started_at:'2026-09-13T00:00:00Z'},
  csrfToken:'token1'
});
